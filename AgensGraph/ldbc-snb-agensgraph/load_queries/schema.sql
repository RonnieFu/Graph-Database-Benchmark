...
-- Forum
\set file_name :source_path/dynamic/forum_0_0.csv
...
-- Person's email
\set file_name :source_path/dynamic/person_email_emailaddress_0_0.csv
...
-- Person's language
\set file_name :source_path/dynamic/person_speaks_language_0_0.csv
...
-- Place
\set file_name :source_path/static/place_0_0.csv
...
-- Tag
\set file_name :source_path/static/tag_0_0.csv
...
-- TagClass
\set file_name :source_path/static/tagclass_0_0.csv
...
\set file_name :source_path/dynamic/post_0_0.csv
...
\set file_name :source_path/dynamic/comment_0_0.csv
...
-- Edge
--- containerOf
\set file_name :source_path/dynamic/forum_containerOf_post_0_0.csv
...
--- hasCreator (for Post)
\set file_name :source_path/dynamic/post_hasCreator_person_0_0.csv
...
\set file_name :source_path/dynamic/comment_hasCreator_person_0_0.csv
...
--- hasInterest
\set file_name :source_path/dynamic/person_hasInterest_tag_0_0.csv
...
-- hasMember
\set file_name :source_path/dynamic/forum_hasMember_person_0_0.csv
...
--- hasModerator
\set file_name :source_path/dynamic/forum_hasModerator_person_0_0.csv
...
--- hasTag (post)
\set file_name :source_path/dynamic/post_hasTag_tag_0_0.csv
...
--- hasTag (comment)
\set file_name :source_path/dynamic/comment_hasTag_tag_0_0.csv
...
--- hasTag (forum)
\set file_name :source_path/dynamic/forum_hasTag_tag_0_0.csv
...
--- hasType
\set file_name :source_path/static/tag_hasType_tagclass_0_0.csv
...
\set file_name :source_path/static/organisation_isLocatedIn_place_0_0.csv
...
--- isLocatedIn (post)
\set file_name :source_path/dynamic/post_isLocatedIn_place_0_0.csv
...
--- isLocatedIn (comment)
\set file_name :source_path/dynamic/comment_isLocatedIn_place_0_0.csv
...
--- isLocatedIn (person)
\set file_name :source_path/dynamic/person_isLocatedIn_place_0_0.csv
...
--- isPartOf
\set file_name :source_path/dynamic/place_isPartOf_place_0_0.csv
...
--- isSubclassOf
\set file_name :source_path/static/tagclass_isSubclassOf_tagclass_0_0.csv
...
--- knows
\set file_name :source_path/dynamic/person_knows_person_0_0.csv
...
--- likes (post)
\set file_name :source_path/dynamic/person_likes_post_0_0.csv
...
--- likes (comment)
\set file_name :source_path/dynamic/person_likes_comment_0_0.csv
...
--- replyOf (post)
\set file_name :source_path/dynamic/comment_replyOf_post_0_0.csv
...
--- replyOf (comment)
\set file_name :source_path/dynamic/comment_replyOf_comment_0_0.csv
...
--- studyAt
\set file_name :source_path/dynamic/person_studyAt_organisation_0_0.csv
...
--- workAt
\set file_name :source_path/dynamic/person_workAt_organisation_0_0.csv
